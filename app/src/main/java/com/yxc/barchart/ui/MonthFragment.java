...
public class MonthFragment extends BaseFragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container,
        ...
        initView(view);
        initData();
        bindBarChartList(32, TestData.createMonthEntries(), TestData.VIEW_MONTH);
        reSizeYAxis();
        setListener();
        return view;
    }
    ...
    private void initData(){
        ...
        mXAxis.setValueFormatter(new XAxisMonthFormatter(getActivity()));
    ...
    private DistanceCompare createDistanceCompare(RecyclerView recyclerView){
        ...
        return TimeUtil.createMonthDistance(barEntry.localDate);
//        if (mType == VIEW_MONTH) {
