...
public class RainbowItem extends View {
    /**
     * 路径
     */
    private Path mPath;
    ...
    public RainbowItem(Context context, int radius, int clipRadius, int number, int colorResource) {
        this(context, null);
    ...
    public RainbowItem(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
        this.mContext = context;
        init();
    }

    public RainbowItem(Context context, AttributeSet attrs, int defStyleAttr) {
