 ...
 * @date 2019-09-27
 */
public class ThreeTargetView2 extends View {
    ...
    public ThreeTargetView2(Context context) {
        super(context);
        this.mContext = context;
        init();
    }

    public ThreeTargetView2(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        init();
    }

    public ThreeTargetView2(Context context, AttributeSet attrs, int defStyleAttr) {
