 ...
 * @date 2019/4/6
 */
public class BaseBarEntry extends Entry implements Comparable<BaseBarEntry> {
    ...
    public BaseBarEntry(float x, float y, long timestamp, int type){
        super(x, y);
    ...
    @Override
    public int compareTo(@NonNull BaseBarEntry o) {
    ...
    public boolean equals(Object o) {
        ...
        BaseBarEntry barEntry = (BaseBarEntry) o;
